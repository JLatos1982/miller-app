...
async function controlRoomSummarySnapshot() {
 ...
 const [findings,pulse,incidents,deployment,maintenance,healthSignals,resourceReviews,shelterReviews,locationReviews,attachments,events]=await Promise.all([
 ...
 if([findings,pulse,incidents,deployment,maintenance,healthSignals,resourceReviews,shelterReviews,locationReviews,attachments,events].some((item)=>item.error))throw new Error("control_room_summary_unavailable")
