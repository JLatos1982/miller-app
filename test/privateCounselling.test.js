...
test("private counselling is a secondary mailto-only accessible modal", () => {
  ...
  assert.match(app, /Miller offers volunteer resource-navigation support, not clinical counselling or therapy/)
  assert.doesNotMatch(app, /Miller is an AI-assisted resource guide, not a therapist/)
