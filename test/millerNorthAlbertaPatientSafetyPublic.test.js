...
test("Alberta patient-safety dossier is source-backed and candid about outcome reporting", () => {
  assert.deepEqual(validateAlbertaPatientSafetyProjection(record), { valid: true, timeline_events: 6, evidence_edges: 7, source_count: 17, maturity: "dossier_ready_with_gaps" })
