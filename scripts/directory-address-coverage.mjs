...
const report = buildDirectoryCoverageReport({ registry, aliases, tavilyResources, curatedResources: curatedMapResources, locations, claims, evidence, inventory, geocoded })
