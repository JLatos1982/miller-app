...
export default function ShelterThroughputQueue() {
  const [report, setReport] = useState(null), [status, setStatus] = useState("Loading shelter action queue…"), [tier, setTier] = useState("tier_a_bulk_confirmable"), [busy, setBusy] = useState(""), [expanded, setExpanded] = useState("")
