...
export const treaty6ProcurementAssistantV2 = Object.freeze({
  ...
  sections: {
    ...
    recent_awards: [],
    contract_pathways: [
      { type: "SUPPLIER_REGISTRATION", title: "CanadaBuys and SAP Business Network", access: "ACCOUNT_REQUIRED", relevance: "Federal tenders, public-sector RFIs and supplier visibility.", summary: "CanadaBuys directs businesses to SAP accounts to view and bid on PSPC opportunities. Samwise links to this path but does not sign in, register suppliers or monitor account-only content.", source_url: "https://canadabuys.canada.ca/en/account-access" },
      { type: "PRIVATE_SOURCING_EVENT", title: "SAP Business Network Discovery", access: "ACCOUNT_REQUIRED", relevance: "Technology, professional services, supplies and enterprise sourcing.", summary: "SAP describes searchable supplier profiles and opportunity responses; public-sector RFIs may be available to supplier accounts, while private-sector response access can be limited by account tier. No account-only lead is republished here.", source_url: "https://www.sap.com/canada/products/business-network/suppliers/overview.html" },
      { type: "BUYER_PORTAL", title: "SaskPower supplier resources", access: "PUBLIC_LINK_ONLY", relevance: "Utility, environmental, vegetation, construction, industrial and supplier-diversity pathways.", summary: "SaskPower publishes supplier resources, current-supply-opportunity links and supplier-information sessions. Its contractor/vendor portal is for invited external vendors and partners.", source_url: "https://www.saskpower.com/about-us/for-our-suppliers/supplier-resources" },
      { type: "PRIVATE_SOURCING_EVENT", title: "BidCentral construction marketplace", access: "MEMBERSHIP_REQUIRED", relevance: "Construction, subcontracting and pre-bid project discovery.", summary: "BidCentral advertises public, private, pre-bid and permit-related project discovery. Detailed project documents and some marketplace features are account or premium-access services; Samwise does not bypass those controls.", source_url: "https://www.bidcentral.ca/" },
      { type: "BUYER_PORTAL", title: "Alberta Health Services procurement", access: "PUBLIC_LINK_ONLY", relevance: "Institutional supplies, services and facilities pathways.", summary: "AHS states that current business opportunities are posted on Alberta Purchasing Connection. Tender-specific supplier requirements remain controlled by the official notice.", source_url: "https://www.albertahealthservices.ca/about/page207.aspx" },
    ],
  },
