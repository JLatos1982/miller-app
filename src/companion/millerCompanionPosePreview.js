...
export const CLASSIC_WALK_POSE_SLOTS = Object.freeze({
  ...
  stepLeft01: Object.freeze({ asset: '../assets/miller/interaction/classic-miller-step-left-01.png', anchors: Object.freeze({ ground: Object.freeze({ x: .5, y: .97 }), bodyCenter: Object.freeze({ x: .5, y: .52 }) }), approved: true }),
  stepLeft02: Object.freeze({ asset: '../assets/miller/interaction/classic-miller-step-left-02.png', anchors: Object.freeze({ ground: Object.freeze({ x: .5, y: .97 }), bodyCenter: Object.freeze({ x: .5, y: .52 }) }), approved: true }),
})
