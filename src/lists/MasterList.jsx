...
export default function MasterList({ onBack }) {
  ...
  const cities = useMemo(() => [...new Set(allResources.map((item) => item.city || item.region).filter(Boolean))].sort(), [])
