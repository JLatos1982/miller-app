export const MILLER_NORTH_PUBLIC_SECTIONS = Object.freeze([
  ...
  Object.freeze({ id: "treaty6_businesses", label: "Treaty 6 Businesses", href: "/north/treaty6-businesses" }),
])
...
export const MILLER_NORTH_PUBLIC_SECTION_ALIASES = Object.freeze({
  ...
  supports: "supports",
  funding: "supports",
  procurement: "treaty6_businesses",
  treaty6_businesses: "treaty6_businesses",
})
...
export const MILLER_NORTH_PUBLIC_PLACEMENT_RULES = Object.freeze({
  ...
  treaty6_businesses: Object.freeze({
    primary_home: "publication-safe Treaty 6 business directory information from public sources",
    includes: Object.freeze(["business_directory_entry", "public_business_source"]),
  }),
})
