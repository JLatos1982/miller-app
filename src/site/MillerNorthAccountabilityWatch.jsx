...
export default function MillerNorthAccountabilityWatch() {
  return <main className="mnaw-page">
    <header className="mnaw-header"><MillerNorthHomeLink className="mnaw-home"/><div className="mnaw-brand"><span>M</span><div><strong>Miller North</strong><small>First Nations Healthcare Evidence</small></div></div><MillerNorthPublicNav current="research"/></header>
