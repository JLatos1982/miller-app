...
const SEARCH_TYPE_LABELS = { incident: "Incident", evidence: "Evidence", listening: "Live Listening", accountability: "Accountability", research_report: "Research / report" }
...
export default function IndigenousHealthcareEvidence() {
  ...
  return <main className="ihe-page" aria-labelledby="ihe-title">
    <header className="ihe-header"><MillerNorthHomeLink className="ihe-back"/><MillerNorthPublicNav current="evidence"/><p className="ihe-eyebrow">Evidence Library · reconciled public records</p><h1 id="ihe-title">First Nations Healthcare Evidence</h1><p className="ihe-lede">A source-first library of reviewed public evidence about racism, discrimination, and related harmful or inequitable First Nations healthcare experiences. Multiple source rows can be presented together when they clearly describe the same evidence context.</p></header>
